...
**The design system.** I redesigned the athlete app around one idea: the screen shows which rule made every change. Six gated phases produced research, a new IA and onboarding, a deterministic safety layer, a 3-tier token system with contrast and colour-vision gates, a [high-fidelity prototype on the production engine](https://ossamamokhtar.github.io/PolySync/prototype/) (13 taps to the first set; 0 automated WCAG 2.2 AA violations), and a published tokens package with Storybook and governance. Building on the real engine exposed six missing engine behaviours, now the engineering build list ([design case study](https://github.com/OssamaMokhtar/polysync-design-system/blob/main/case-study/README.md)).
